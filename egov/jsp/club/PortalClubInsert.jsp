<%--
  Class Name : PortalClubInsert.jsp
  Description : 동아리 등록View JSP
                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
								...
								<form:form modelAttribute="clubMasterVO" action="${pageContext.request.contextPath}/portal/club/ClubInsert.do" name="clubMasterVO" method="post" >

                                <h1 class="tit_1">시민문화관리</h1>

                                <h2 class="tit_2">동아리 등록</h2>
                                    ...
                                    <table>
                                        ...
                                        <tr>    
                                            ...
                                            <td class="rdoSet"><!-- 2개이상 radio 있을때 필요 -->
												<form:radiobutton path="status" id="Wait" value="Wait" checked="checked" />
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
                                        <a href="#LINK" class="btn btn_skyblue_h46 w_100" onclick="javascript:document.clubMasterVO.reset();"><spring:message code="button.reset" /></a><!-- 초기화 -->
                                    </div>
						        ...
						        <input type="hidden" name="pageIndex" value="<c:out value='${clubMasterVO.pageIndex}'/><c:if test="${clubMasterVO.pageIndex eq null}">1</c:if>"/>
