<%--
  Class Name : PortalSurveyRegist.jsp
  Description : 설문조사 등록View JSP
                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
								...
								<form:form modelAttribute="surveyMasterVO" action="${pageContext.request.contextPath}/portal/survey/SurveyInsert.do" name="surveyMasterVO" method="post" >

                                <h1 class="tit_1">설문조사관리</h1>

                                <h2 class="tit_2">설문조사 등록</h2>
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input path="pageUrl" id="pageUrl" class="f_txt w_full" maxlength="500" />
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
                                        <a href="#LINK" class="btn btn_skyblue_h46 w_100" onclick="javascript:document.surveyMasterVO.reset();"><spring:message code="button.reset" /></a><!-- 초기화 -->
                                    </div>
						        ...
						        <input type="hidden" name="pageIndex" value="<c:out value='${surveyMasterVO.pageIndex}'/><c:if test="${surveyMasterVO.pageIndex eq null}">1</c:if>"/>
