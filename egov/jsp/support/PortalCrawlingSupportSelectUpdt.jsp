...
<head>
    ...
    <title>내부업무 사이트 > 지원사업관리 > 지원사업 수정</title>
    ...
    function fnDeleteSupport(sq) {
        if(confirm("<spring:message code='common.delete.msg' />")){
            document.crawlingSupportMasterVO.checkedSqForDel.value=sq;
            document.crawlingSupportMasterVO.action = "<c:url value='/portal/support/SupportDelete.do'/>";
            document.crawlingSupportMasterVO.submit(); 
        }
    }
                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <form:form modelAttribute="crawlingSupportMasterVO" action="${pageContext.request.contextPath}/portal/support/SupportSelectUpdt.do" name="crawlingSupportMasterVO" method="post" >
                                
                                <!-- 지원사업 삭제시 prameter 전달용 input -->
                                ...
                                <input type="hidden" name="pageIndex" value="<c:out value='${crawlingSupportMasterVO.pageIndex}'/>"/>

                                <h1 class="tit_1">지원사업관리</h1>

                                <h2 class="tit_2">지원사업 상세조회(수정)</h2>
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input path="source" id="source" class="f_txt w_full" maxlength="15" readonly="readonly"/>
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
                                        <a href="#LINK" class="btn btn_skyblue_h46 w_100" onclick="javascript:fnDeleteSupport('<c:out value='${crawlingSupportMasterVO.sq}'/>'); return false;"><spring:message code="button.delete" /></a><!-- 삭제 -->
                                    </div>
