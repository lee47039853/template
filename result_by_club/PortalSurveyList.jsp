                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <!-- 검색조건 -->
                                <div class="condition">
                                    <label class="item f_select" for="responseCd">
                                        <select name="responseCd" id="responseCd" title="검색조건1-응답코드">
                                            <option value="0" <c:if test="${empty surveyMasterVO.responseCd || surveyMasterVO.responseCd == '0'}">selected="selected"</c:if> >응답코드(전체)</option>
                                            <option value="Accept" <c:if test="${surveyMasterVO.responseCd == 'Accept'}">selected="selected"</c:if> ><spring:message code="portal.status.accept" /></option>
                                            <option value="Wait" <c:if test="${surveyMasterVO.responseCd == 'Wait'}">selected="selected"</c:if> ><spring:message code="portal.status.wait" /></option>
                                            <option value="Deny" <c:if test="${surveyMasterVO.responseCd == 'Deny'}">selected="selected"</c:if> ><spring:message code="portal.status.deny" /></option>
                                        </select>
                                    </label>
                                ...
                                <div class="board_list_top">
                                    ...
                                    <div class="right_col">
                                    	...
                                    	<a href="<c:url value='/portal/survey/SurveyInsertView.do'/>" class="item btn btn_blue_46 w_100" onclick="fnAddSurveyView(); return false;"><spring:message code="button.insert" /></a><!-- 등록 -->
                                    </div>
                                </div>
